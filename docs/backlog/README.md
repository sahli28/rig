...
| ------- | --------------- | ------------------------ | ------------: |
| **① Jalon pilote** | que l'outil sert, en vrai, tous les jours | réserver, annuler, faire la queue, pointer | **30,5 j·h** |
...
## ① Jalon pilote — 97,75 j·h, dont **30,5 restants**
...
P1-003c ✅ fait → P1-011 ✅ fait          (la feuille d'inscrits, puis le bandeau de semaine du planning)
...
| P1-011  | Bandeau de semaine : atteindre un jour en un tap  |    1,5 | ✅ **fait le 5 sept. 2026** — un tap au lieu de six. **Aucun préchargement, mesuré** : une seule entrée de cache après ouverture du planning, deux après un tap. Reste le balayage sur appareil |
...
|         | **Total ①**                                       | **97,75** | dont **67,25 faits**, **30,5 restants** |
