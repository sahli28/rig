...
| ------- | --------------- | ------------------------ | ------------: |
| **① Jalon pilote** | que l'outil sert, en vrai, tous les jours | réserver, annuler, faire la queue, pointer | **35,5 j·h** |
...
## ① Jalon pilote — 90,25 j·h, dont **35,5 restants**
...
```
P0-005b                                (SSO Google)
D-009 ✅ → P1-002b ✅ → P1-010 → P1-003b   (navigation, planning, coachs, réservation)
...
| P1-002b | Planning mobile et cache hors ligne               |    3,5 | ✅ fait — **sans le filtre coach**, faute de source (P1-010). Reste la passe appareil |
| P1-010  | Annuaire des coachs, lisible par un membre        |      1 | à faire — **débloque le coach** sur le planning et le détail d'un cours |
...
| P1-009  | Sélecteur de box (mobile)                         |    1,5 | à faire — après le jalon. La place lui est laissée dans l'en-tête du planning |
|         | **Total ①**                                       | **90,25** | dont **54,75 faits**, **35,5 restants** |
